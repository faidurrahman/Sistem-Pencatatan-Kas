...
// --- API URL ---
const API_URL = 'https://script.google.com/macros/s/AKfycbwyl_yBbToMVqlSQ4zAoNphKEtLkPyzYAng3I87pPnPbC8bPog46WrpAouNBgYfIgWqug/exec?sheet=General';
    ...
    return new Promise((resolve) => {
      ...
      reader.onload = (event) => {
        ...
        img.onload = () => {
          ...
          // Shrink more aggressively to fit inside ~30-40KB for Google Sheets limit (50000 chars)
          ...
          if (ctx) {
            ...
            // Re-compress if still too large (Google sheets limit is 50,000 characters which is ~37KB base64)
